...
const FALLBACK: Project[] = [
  ...
  { title: 'Hunt in the Rain', cat: 'video', cat_label: 'Showreel — Video Editing', img: '/assets/hitr.webp', desc: 'A <strong>rain-soaked cinematic short</strong> — cut in wet light, with the tension carried by the edit and the grade rather than the dialogue. <strong>Edited and colour graded</strong> end to end, and the second film opening the <strong>’26 showreel</strong>.', role: 'Editor & Colorist', stack: 'Final Cut Pro', year: '2026', action: 'watch the film', video: 'https://pub-fe9b85f97c6a4773bbf0ceb5f53c430b.r2.dev/HITR.mp4' },
